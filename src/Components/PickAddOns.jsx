        ...
        <div className="flex flex-col gap-20 mt-5 ">
            ...
            <div className="flex flex-col justify-center items-start gap-5 w-full">
              <div className="flex justify-between items-center bg-white w-120 p-4 rounded-lg border border-Purple-200">
                <div className="flex justify-center items-center gap-10">
                  ...
                  <div>
                    <p className="text-Blue-950 font-U-Bold text-xl">
                      Online service
                    </p>
                    <p className="text-Grey-500 font-U-Med">
          ...
          <div className="w-full max-w-120 flex justify-between">
            ...
            <button
              type="submit"
              onClick={handleNext}
              className="flex justify-center items-center p-3 rounded-lg bg-Blue-950 text-Blue-50 font-U-Bold text-lg w-35 cursor-pointer"
            >
              Next Step
            </button>
          </div>
